...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="http://127.0.0.1:8000/getAdminMsgPge" target="iframe_content" class="dropdown-item dropdown-footer">See All Notifications</a>
        </div>
      </li>
      <li class="nav-item">
        @if(Auth::check())
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      ...
      <span class="brand-text font-weight-light">System Admin Panel</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="http://127.0.0.1:8000/getallusers" target="iframe_content" class="nav-link">
          ...
          <li class="nav-item">
            <a href="http://127.0.0.1:8000/viewMyProfileAd" target="iframe_content" class="nav-link">
          ...
          <li class="nav-item">
            <a href="http://127.0.0.1:8000/viewAllPost" target="iframe_content" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="http://127.0.0.1:8000/getAdminMsgPge" target="iframe_content" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Admin Notifications</p>
                </a>
              </li>
            </ul>
          </li>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <main class="page-content">
          <iframe id="iframe_content" name="iframe_content" class="iframe_content" src="http://127.0.0.1:8000/getallusers"></iframe>
        </main>
      </div><!-- /.container-fluid -->
    </div>
    <!-- /.content-header -->
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form id="complaint_form" class="row g-3">
            ...
            <div class="col-md-12">
              <label for="name" class="form-label">Complaint</label>
            ...
            <div class="col-12">
              <div class="col text-center">
                ...
                <!-- <button type="button" class="btn btn-info">For Test</button> -->

                <!-- <input type="button" class="btn btn-warning" id="lname" name="lname"> -->
              </div>
            </div>
          </form>
        </div>
